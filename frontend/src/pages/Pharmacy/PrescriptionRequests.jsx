...
const allRx = [
  ...
  { id:"RX-006", patient:"Deepa Iyer",     age:38, doctor:"Dr. Anil Kumar",   date:"10 Jul 2026", status:"Pending",   items:["Clindamycin 300mg x2","Ibuprofen 400mg x1"], type:"Walk-in" },
  { id:"RX-007", patient:"Arjun Mehta",    age:22, doctor:"Dr. Sara Thomas",  date:"09 Jul 2026", status:"Dispensed", items:["Doxycycline 100mg x1","Probiotics x1"], type:"Online"  },
];
...
export default function PrescriptionRequests() {
  ...
  const [rxList,     setRxList]     = useState(allRx);
